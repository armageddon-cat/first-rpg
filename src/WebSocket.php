...
class WebSocket
{
    ...
    {
        if (empty($connect) || !\is_resource($connect)) {
            die('invalid resource given');
        }
    ...
    public function handshake()
    {
        ...
        $clientAddress = explode(':', stream_socket_get_name($this->connect, true));
        $info['ip'] = $clientAddress[0];
        $info['port'] = $clientAddress[1];
